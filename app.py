...
app.config['SQLALCHEMY_DATABASE_URI'] = os.environ.get(
    'DATABASE_URL',
    'mysql+pymysql://admin:admin123@terraform-20250221193422726200000001.cxac8gmue0ap.us-east-1.rds.amazonaws.com:3306/flaskdb'
)
...
if __name__ == "__main__":
    #app.run(host="0.0.0.0", port=5000) -- use this to run docker locally
    app.run(debug=True) # Use this to run in lambda environment
